...
-- existing "Expense — X" accounts/vouchers stay meaningful and the six
-- categories people already use don't just vanish from the dropdown.
--
-- Local:   psql "$DATABASE_URL" -f db/migrations/003_expense_categories.sql
-- Railway: psql "PASTE_DATABASE_PUBLIC_URL_HERE" -f db/migrations/003_expense_categories.sql
